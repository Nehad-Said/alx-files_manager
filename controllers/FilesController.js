...
import { connectType } from 'mime-types';
import mongoDBcore from 'mongodb/lib/core';
import dbClient from '../utils/db';
import { geUserFromXToken } from '../utils/auth';
...
const writeFileAsynch = promisify(writeFile);
...
export default class FilesController {
     ...
     * @param {Response} res the Express response oject.
     */
